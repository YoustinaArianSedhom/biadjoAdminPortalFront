...
const mutations = {
  ...
  UPDATE_NotificationList(state, val) {
    var Obj = {};
    Obj.ID = val.data.ID || val.data.Biadjo_ID;
    Obj.Biadjos_Count = val.data.Biadjos_Count || "";
  ...
  RemoveFrom_NotificationList(state, val) {
    // state.NotificationList.pop(val);
    state.NotificationList.splice(val, 1);
  },
  RemoveFrom_AllNotificationList(state, val) {
    // state.NotificationList.pop(val);
  ...
  UpdateSelectedCountryCode(state, SelectedCountryCode) {
    state.SelectedCountryCode = SelectedCountryCode;
  },
  UpdateSelectedCountryName(state, SelectedCountryName) {
    state.SelectedCountryName = SelectedCountryName;
  },
  UpdateSessionExpired(state, SessionExpired) {
    state.SessionExpired = SessionExpired;
  },
  REMOVE_USER_STORE(state) {
    state.AppActiveUser = {};
  },
  Get_Location_Data(state, mapObject) {
