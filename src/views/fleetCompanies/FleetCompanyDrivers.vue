    ...
    <div class="w-full" id="Scroll">
      <vx-card>
        <div
          ...
          v-if="CompanyDrivers != undefined || CompanyDrivers != null"
        >
          <vs-table
            ref="table"
            search
            ...
            <template slot-scope="{ data }">
              <tbody>
                <vs-tr :data="tr" :key="indextr" v-for="(tr, indextr) in data">
                  ...
                  <vs-td>
                    <p class="VehicleType">{{ $t(tr.VehicleType) }}</p>
                  </vs-td>
                  <vs-td>
                  ...
                  <vs-td>
                    <p class="accountstatus">{{ $t(tr.AccountStatus) }}</p>
                  </vs-td>
...
export default {
  ...
  methods: {
    ...
    FetchDrivers() {
      ...
      this.$store
        .dispatch("CompanyList/GetCompanyDrivers", JsonObj)
        .then(response => {
