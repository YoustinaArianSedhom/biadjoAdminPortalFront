<template>
  <div>
    ...
    <!-- 
    <vx-card class="mb-base" :title="Model.Question1" title-color="primary">
      <div class="vx-row">
         <input type="range" min="1" max="10" v-model="Model.Answer1" />
        <label class="mt-4 ml-4"> {{ Model.Answer1 }}</label> 
      </div>
    </vx-card> -->
    ...
    <!-- <vx-card class="mb-base" :title="Model.Question2" title-color="primary">
      <div class="vx-row flex justify-end">
         <input type="range" min="1" max="10" v-model="Model.Answer2" />
        <label class="mt-4 ml-4"> {{ Model.Answer2 }}</label> 
      </div>
    </vx-card> -->
    ...
    <!-- <vx-card class="mb-base" :title="Model.Question3" title-color="primary">
      <div class="vx-row">
         <input type="range" min="1" max="10" v-model="Model.Answer3" />
        <label class="mt-4 ml-4"> {{ Model.Answer3 }}</label> 
      </div>
    </vx-card> -->

    <!-- Question-4  -->
    <vx-card class="mb-base">
      <div class="vx-row" vs-type="flex">
        <vs-col class="m-4 justify-end" vs-type="flex">
          <h1 class="m-1 text-primary">
            {{ Model.Question4 }}
          </h1>
    ...
    <vs-row class="m-4 justify-center" vs-type="flex">
      <vs-button
        class="mr-2"
        type="border"
        color="warning"
        ...
        >{{ $t("Back") }}</vs-button
      >
      <vs-button class="" @click="onSubmit">{{ $t("Submit") }}</vs-button>
    </vs-row>
  </div>
</template>
...
export default {
  data() {
    return {
      Model: {
        Question1: "الحالة الصحية للسائق",
        Answer1: "5",

        Question2: "حالة المركبة",
        Answer2: "5",

        Question3: "حالة البضاعة",
        Answer3: "5",

        Question4: "هل يوجد اي مواد خطرة او زيوت او سوائل ع الطريق العام",
        Answer4: "لأ",

        Question5: "هل تم أخذ صور للحادث و البضاعة",
        Answer5: "لأ",

        Question6: "هل تم ابلاغ العميل",
        Answer6: "لأ",

        Question7: "هل تم ابلاغ الشرطة",
        Answer7: "لأ"
      }
    };
  },
