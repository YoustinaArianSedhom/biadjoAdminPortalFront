<template>
  <div class="vx-row">
      ...
      <div class="vx-row">
        ...
        <div class="vx-col">
          <table>
            ...
            <tr>
              <td class="font-semibold pb-2 pr-10 pl-10">
    ...
    <div class="vx-col w-full sm:w-full md:w-1/3 lg:w-1/3 xl:w-1/3 ">
      <div class="vx-row">
        <div class="vx-col ">
          ...
          <div v-if="ReviewData.Stops.length > 0">
    ...
    <div class="vx-row w-full text-center align-center">
      <div class="vx-row  w-full sm:w-2/3 md:w-2/3 lg:w-2/3 xl:w-2/3">
        <vs-checkbox
      ...
      <div class="vx-row  w-full sm:w-1/3 md:w-1/3 lg:w-1/3 xl:w-1/3">
        <label class="mr-2 ml-2">{{ $t("SendToDrivers") }}</label>
        <vs-switch v-model="ReviewData1.SendToDrivers" />
      </div>
    </div>
  </div>
</template>
