    ...
    <div class="w-full" id="Scroll">
      <vx-card>
        <div
          ...
          v-if="Clients != undefined || Clients != null"
        >
          <vs-table
            ref="table"
            v-model="selected"
          ...
          >
            ...
            <template slot="thead">
              ...
              <!-- <vs-th sort-key="CountryCode">{{ $t("CountryCode") }}</vs-th> -->
...
export default {
  ...
  methods: {
    ...
    Search() {
      ...
      // let Client = {};
      this.Client.UserID = this.$route.params.Id;
      this.$store
        .dispatch("ClientList/GetTransactionsUsers", this.Client)
        .then(response => {
