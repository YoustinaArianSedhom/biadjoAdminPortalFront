            ...
            <table>
              ...
              <tr>
                ...
                <td>
                  <vs-input
                    class="w-full"
                    v-model="FormData.VehicleOWnerFullName"
                    v-validate="'required'"
                    name="VehicleOwnerFullName"
                  />
                  <span
                    class="text-danger text-sm"
                    v-show="errors.has('VehicleOwnerFullName')"
                    >{{ errors.first("VehicleOwnerFullName") }}</span
                  >
                </td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td>
                  ...
                  <span
                    class="text-danger text-sm"
                    v-show="errors.has('DriverLicense')"
                    >{{ errors.first("DriverLicense") }}</span
                  >
                </td>
              </tr>
            </table>
            ...
            <table>
              ...
              <tr>
                ...
                <td>
                  ...
                  <span
                    class="text-danger text-sm"
                    v-show="errors.has('NationalID')"
                    >{{ errors.first("NationalID") }}</span
                  >
                </td>
              </tr>
              <tr>
                ...
                <td>
                  ...
                  <span
                    class="text-danger text-sm"
                    v-show="errors.has('TaxID')"
                    >{{ errors.first("TaxID") }}</span
                  >
                </td>
              </tr>
              <tr>
            ...
            <table>
              <tr>
                ...
                <td>
                  ...
                  <span
                    class="text-danger text-sm"
                    v-show="errors.has('LicensePlate')"
                    >{{ errors.first("LicensePlate") }}</span
                  >
                </td>
              </tr>
              <tr>
            ...
            <table>
              <tr>
                ...
                <td style="width:75vw">
                  ...
                  <span
                    class="text-danger text-sm"
                    v-show="errors.has('VehicleMake')"
                    >{{ errors.first("VehicleMake") }}</span
                  >
                </td>
              </tr>
              <tr>
                ...
                <td>
                  ...
                  <span
                    class="text-danger text-sm"
                    v-show="errors.has('VehicleModel')"
                    >{{ errors.first("VehicleModel") }}</span
                  >
                </td>
              </tr>
              <tr>
                ...
                <td>
                  ...
                  <span
                    class="text-danger text-sm"
                    v-show="errors.has('VehicleColor')"
                    >{{ errors.first("VehicleColor") }}</span
                  >
                </td>
              </tr>
            </table>
  ...
  computed: {
    ...
    validateForm() {
      return (
        ...
        this.FormData.TaxID != "" &&
        this.FormData.VehicleOWnerFullName != "" &&
